            ...
            <m.div initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 0.3, ease: 'easeInOut'}} exit={{opacity: 0}}>
                <main className="isolate">
                    ...
                    <div className="mx-auto mt-16 max-w-7xl px-6 lg:px-8">
                        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">{copy.timeline.heading}</h2>
                    ...
                    {/* Image section */}
                    <div className="mt-16 xl:mx-auto xl:max-w-7xl xl:px-8">
                    <Image
                        src={sunflowerBG}
                        alt={copy.bgAlt}
                            ...
                            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                                ...
                                <dl className="col-span-2 grid grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2">
                                    ...
                                    <div key={feature.name}>
                                        ...
                                        <div className="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-lime-700">
                    ...
                    <div className="bg-white">
                        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
                            <RevealElement>
                                ...
                                <Link href={copy.cta.secondaryHref} className="text-sm font-semibold leading-6 text-gray-900">
                                    {copy.cta.secondary} <span aria-hidden="true">→</span>
                                </Link>
                                </div>
                            </RevealElement>
                        </div>
