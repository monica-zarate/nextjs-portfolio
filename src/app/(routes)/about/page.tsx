                ...
                <div className="lg:ml-auto lg:pl-4 lg:pt-4">
                  <RevealElement>
                    <div className="lg:max-w-lg">
                      <h2 className="playpen text-base font-semibold leading-7 text-lime-700">
                        {copy.h2}
                      </h2>
                        ...
                        {copy.featured.map((feature, i) => (
                          <div key={i} className="relative pl-9">
                            ...
                            >
                              <FontAwesomeIcon
                                icon={faSeedling}
                                className="absolute left-1 top-1 h-5 w-auto text-lime-600"
                              />
                              {feature}
                            </dt>{" "}
                          </div>
              ...
              <div className="mx-auto mt-6 grid max-w-2xl grid-cols-1 gap-8 overflow-hidden lg:mx-0 lg:max-w-none lg:grid-cols-3">
                {copy.workTimeline.events.map((role) => (
                  <div key={role.title}>
                    ...
                    <p className="mt-6 text-sm font-semibold leading-8 tracking-tight text-gray-700">
                      {role.company}
                    </p>
            ...
            <RevealElement>
              ...
              <ul className="mx-auto mt-6 lg:mx-0 lg:max-w-none flex flex-wrap">
                {copy.skills.list.map((item, i) => (
                  <RevealElement key={i}>
                    <li className="">
                      <span className="text-lime-700 bg-lime-50 ring-lime-700/10 inline-flex items-center rounded-md px-2 py-1 text-sm font-medium ring-1 ring-inset mb-2 mr-2 w-fit capitalize">
                        {item}
                      </span>
                    </li>
                  </RevealElement>
